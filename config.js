...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~LVEDWCaB#XOorvJYnN9BAP8lt_-mVTu8nhdBchE-KOloYCPoJffU",
...
STICKER_NAME: process.env.STICKER_NAME || "~•N∆§RINE♪DMF•~",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false", 
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "false",
OWNER_NUMBER: process.env.OWNER_NUMBER || "242068134010",
OWNER_NAME: process.env.OWNER_NAME || "~•N∆§RINE♪DMF•~",
