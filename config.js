...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INCONNU~XD~bV0HURDS#4vdQaVnszbFTwyfAHJJYah23nlEOip88p5qlc2neH5A",
...
STICKER_NAME: process.env.STICKER_NAME || "Nasrine",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false", 
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "false",
OWNER_NUMBER: process.env.OWNER_NUMBER || "241077450591",
OWNER_NAME: process.env.OWNER_NAME || "Nasrine",
